...
PAIRS: list[CalibrationPair] = [
    ...
    CalibrationPair("What is an ETF?",
    ...
    CalibrationPair("What is a Roth IRA?",
                    "Explain the Roth IRA to me",
                    "equivalent"),

    CalibrationPair("How does compound interest work?",
    ...
    CalibrationPair("What is dollar-cost averaging?",
                    "DCA explained",
                    "equivalent",
                    "Common acronym"),

    CalibrationPair("What's the 2024 401(k) contribution limit?",
                    "How much can I contribute to my 401k in 2024?",
                    "equivalent"),

    CalibrationPair("What is the S&P 500?",
                    "Tell me about the S&P 500 index",
                    "equivalent"),

    CalibrationPair("How do mutual funds work?",
                    "Explain mutual funds",
                    "equivalent"),

    CalibrationPair("What is asset allocation?",
                    "Define asset allocation",
                    "equivalent"),

    CalibrationPair("What is diversification?",
    ...
    CalibrationPair("What is compound interest?",
    ...
    CalibrationPair("What is a bond?",
    ...
    CalibrationPair("What is the 2024 401(k) contribution limit?",
    ...
    CalibrationPair("What is dollar-cost averaging?",
                    "Analyze my portfolio: $10K AAPL, $5K BND",
                    "unrelated"),
