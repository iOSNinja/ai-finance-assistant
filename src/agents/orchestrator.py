...
class OrchestratorDecision(BaseModel):
    ...
    #     min_length=1,
    agents: list[Literal["qa_agent", "tax_agent", "goal_agent", "portfolio_agent"]] = Field(
        description="List of agents to dispatch. Always at least one.",
        min_length=1,
    )
...
def orchestrator_node(
    state: FinnieState,
) -> Command[Literal["qa_agent_node", "tax_agent_node", "goal_agent_node", "portfolio_agent_node"]]:
