...
class FinnieState(TypedDict):
    ...
    messages: Annotated[list[AnyMessage], add_messages] # full conversation history -> does not need(reset_or_add_messages) reset, needs to persist whole chat history
